...
function Info() {
  const [showCaseButton, setShowCaseButton] = useState([])
  ...
  function linkSwitchs() {
    setShowCaseButton([true, false, false, false, false])
  }

  function switchShowCaseButton(index) {
    setShowCaseButton(prevState =>
  ...
  return (
    <section className="info_container">
      <div className="info_titleField_animation_container">
      ...
      <div className="info_display">
        <div className="info_display_selection_animation_container">
          <div className="info_display_selection">
            <Button content="3D Modeling" color="secondary" stylus="showcase" showCaseOn={switchShowCaseButton} showCaseStatus={showCaseButton[0]} index={0} />
            <Button content="Augmented Reality" color="secondary" stylus="showcase" showCaseOn={switchShowCaseButton} showCaseStatus={showCaseButton[1]} index={1} />
            <Button content="Product Imagery" color="secondary" stylus="showcase" showCaseOn={switchShowCaseButton} showCaseStatus={showCaseButton[2]} index={2} />
            <Button content="Rich Media" color="secondary" stylus="showcase" showCaseOn={switchShowCaseButton} showCaseStatus={showCaseButton[3]} index={3} />
            <Button content="Product Content" color="secondary" stylus="showcase" showCaseOn={switchShowCaseButton} showCaseStatus={showCaseButton[4]} index={4} />
          </div>
        </div>
        <div className="info_display_grid_animation_container">
